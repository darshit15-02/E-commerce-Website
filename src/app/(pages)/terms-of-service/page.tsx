      ...
      <main className="flex-grow">
        <section className="py-16 bg-gradient-to-b from-background to-muted">
          <div className="container mx-auto px-4">
            ...
            >
              <p>Welcome to SparkleCart. By using our website and services, you agree to comply with and be bound by the following terms and conditions:</p>
              
              <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">1. Acceptance of Terms</h2>
              <p>By accessing or using SPARKLECART's website and services, you agree to these Terms of Service and all applicable laws and regulations.</p>
              
              <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">2. Use of Service</h2>
              <p>You agree to use SPARKLECART's services only for lawful purposes and in accordance with these Terms of Service.</p>
              ...
              <p>Your use of SPARKLECART's services is subject to our Privacy Policy. Please review our Privacy Policy, which also governs the site and informs users of our data collection practices.</p>
              ...
              <p>SPARKLECART shall not be liable for any special or consequential damages that result from the use of, or the inability to use, the services and products offered on this site.</p>
              
              <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">9. Governing Law</h2>
              <p>These Terms of Service and your use of the site are governed by and construed in accordance with the laws applicable in the jurisdiction where SPARKLECART operates.</p>
              
              <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">10. Changes to Terms</h2>
              <p>SPARKLECART reserves the right to modify these Terms of Service at any time. We do so by posting and drawing attention to the updated terms on the site. Your decision to continue to visit and make use of the site after such changes have been made constitutes your formal acceptance of the new Terms of Service.</p>
              
              <p className="mt-8">If you have any questions about these Terms of Service, please contact us at legal@SPARKLECART.com.</p>
            </motion.div>
          </div>
        </section>
      </main>
